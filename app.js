...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  // api.ai client
  const apiClient = new ApiAi.ApiAiClient({accessToken: '54eae91722f2410181eebe05f2b51dd7'});

  // Initial feedback message.
  addBotItem("Hi! I’m your Voice Bot Assistant. I'm still in training phase, but feel free to start talking to me.");
